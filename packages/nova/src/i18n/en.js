export default {
  ...
  espresso: {
    ...
    changeBean: 'Switch bean',
    changeGrinder: 'Switch grinder',
    recipes: 'Recipes',
  ...
  profileEditor: {
    ...
    volumeCountStart: 'Track volume starting with',
    stopVolume: 'Stop at volume',
    limitFlowRange: 'Limit flow range',
    limitPressureRange: 'Limit pressure range',
    stopWeight: 'Stop at weight',
    divergentLimiterRanges: 'This profile has different limiter ranges per step — saving here will make them all match.',
  },
  steam: {
    intensity: 'Intensity',
    presets: 'Presets',
  ...
  cleaning: {
    ...
    forwardFlushPrep: 'Insert the portafilter with the blind basket and add cleaning detergent, then press Start.',
    forwardFlushArmed: 'Press the espresso button on the machine to start the cleaning cycle.',
    backflush: 'Backflush',
    descale: 'Descale',
    transport: 'Transport',
    ...
    step1: 'Step 1 of 2',
    step2: 'Step 2 of 2',
    forwardFlushStep1: 'Step 1 of 3',
    forwardFlushStep2: 'Step 2 of 3',
    forwardFlushStep3: 'Step 3 of 3',
    stepProgress: 'Step {x} of {y}',
    running: 'Cleaning in progress…',
    doNotRemovePortafilter: 'Do not remove the portafilter during the cleaning cycle.',
    skipStep: 'Skip step',
    skipStepFailed: 'Skip step failed',
    flushDone: 'Cleaning cycle complete',
